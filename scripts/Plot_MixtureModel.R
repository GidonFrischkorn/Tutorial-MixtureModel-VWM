#' This file creates Figure 1 of the tutorial for fitting mixture models for
#' visual working memory tasks in brms
...
plot_mixModel <- ggplot() +
  geom_function(fun = weighted_vonMises_density,
                args = list(mu = mus[1], kappa = kappas[1], log = F, weight = weights[2]), 
